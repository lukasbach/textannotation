...
/**
 * This selection expands the user selection to include full words.
 *
...
public class WordSelectionStrategy implements SelectionStrategy {
    ...
    @Override
    public String getId() {
        return "selectionstrategy/word";
    }

    @Override
    public String getDescription() {
        return "The selection made in the editor view will be expanded to include full words before being annotated.";
    }
